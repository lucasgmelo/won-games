...
describe('<Galery />', () => {
  it('should render thumbnails as buttons', () => {
    ...
    expect(
      screen.getByRole('button', { name: /Thumb - Galery Image 1/i })
    ).toHaveAttribute('src', mockItems[0].src)

    expect(
      screen.getByRole('button', { name: /Thumb - Galery Image 2/i })
  ...
  it('should open modal with selected image', async () => {
    ...
    const img = await screen.findByRole('img', { name: /Galery Image 2/i })
